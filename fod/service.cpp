...
using vendor::cygnus::biometrics::fingerprint::inscreen::V1_1::IFingerprintInscreen;
using vendor::cygnus::biometrics::fingerprint::inscreen::V1_1::implementation::FingerprintInscreen;
